...
# timer_text = canvas.create_text(-20, 20, text='00:00', fill=BLUE, font=(FONT_NAME, 24, 'bold'))
timer_text = canvas.create_text(100, 200, text='00:00', fill=BLUE, font=(FONT_NAME, 24, 'bold'))
# timer_text = tkinter.Label(text='00:00', fg=BLUE, bg=SAND, font=(FONT_NAME, 24, 'bold'))
