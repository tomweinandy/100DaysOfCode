"""
Day 90: PDF to Audiobook

Instructions: Using what you've learnt about HTTP requests, APIs and Python scripting, create a program that can convert PDF files to speech.
...
"""
# Starter code from https://docs.aws.amazon.com/polly/latest/dg/get-started-what-next.html
